...
namespace GSharp.Sys.Windows.User {
    public class ProcessStarter : IDisposable {
        ...
        public void Run() {
            ...
            CreateProcessAsUser(primaryToken, null, command, ref Security1, ref Security2, false, NORMAL_PRIORITY_CLASS | CREATE_UNICODE_ENVIRONMENT, lpEnvironment, null, ref StartupInfo, out processInfo_);
        ...
        public void Stop() {
            ...
            foreach (System.Diagnostics.Process current in processes) {
