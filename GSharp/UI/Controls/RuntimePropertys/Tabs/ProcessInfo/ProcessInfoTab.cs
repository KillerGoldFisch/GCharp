...
namespace GSharp.UI.Controls.RuntimeProperty.Tabs.ProcessInfo
{
	/// <summary>
	...
	internal class ProcessInfoTab : PropertyTab
	{
		...
		{
			get { return (Bitmap) Bitmap.FromStream(GetType().Assembly.GetManifestResourceStream("GSharp.UI.Controls.RuntimePropertys.Resources.ProcessInfo.bmp")); }
		}
