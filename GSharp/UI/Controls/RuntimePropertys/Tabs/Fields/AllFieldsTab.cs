...
namespace GSharp.UI.Controls.RuntimeProperty.Tabs.Fields
{
	/// <summary>
	...
	internal class AllFieldsTab : PropertyTab
	{
		...
		{
			get { return (Bitmap) Bitmap.FromStream(GetType().Assembly.GetManifestResourceStream("GSharp.UI.Controls.RuntimePropertys.Resources.Fields.bmp")); }
		}
