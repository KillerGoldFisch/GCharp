...
namespace GSharp.UI.Controls.GracialList
{
	...
	public class GlacialList : System.Windows.Forms.Control
	{
		...
		public GlacialList()
		{
			...
			this.hPanelScrollBar = new GSharp.UI.Controls.GracialList.ManagedHScrollBar();
			this.vPanelScrollBar = new GSharp.UI.Controls.GracialList.ManagedVScrollBar();
