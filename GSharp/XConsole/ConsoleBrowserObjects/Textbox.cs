...
namespace GSharp.XConsole.ConsoleBrowserObjects {
    /// <summary>
    /// An object used to manage the data necessary to render read-write
    /// objects to the screen.
    /// </summary>
    public class Textbox : GSharp.XConsole.ConsoleBrowserObjects.StdConsoleObject, System.Xml.Serialization.IXmlSerializable {
